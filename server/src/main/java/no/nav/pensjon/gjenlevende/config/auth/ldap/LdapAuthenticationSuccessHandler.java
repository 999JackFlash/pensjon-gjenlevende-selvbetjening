package no.nav.pensjon.gjenlevende.config.auth.ldap;

import com.fasterxml.jackson.databind.ObjectMapper;
import no.nav.pensjon.gjenlevende.config.auth.JwtService;
import no.nav.pensjon.gjenlevende.config.auth.PresysUser;

...
import no.nav.pensjon.gjenlevende.config.auth.jwt.JwtAuthenticationProcessingFilter;
import no.nav.pensjon.gjenlevende.config.auth.jwt.JwtAuthenticationProvider;
import no.nav.pensjon.gjenlevende.config.auth.ldap.LdapAuthenticationProcessingFilter;
import no.nav.pensjon.gjenlevende.config.auth.ldap.LdapAuthenticationSuccessHandler;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        ...
        web.ignoring().antMatchers("/api/public/**", "/metrics");
